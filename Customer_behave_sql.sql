...
-- Comparing revenue accross Deographics
select gender, sum(purchase_amount) as revenue
from customer
group by gender;

-- Q2. Which customers used a discount but still spent more than the average purchase amount? 
-- Discounts are meant to reduce the amount but few cust use more money than average spend
...
-- The company should focus more on Express type
